...
import freeFire from "/src/assets/ai_ds/events/flagship/freefire.jpeg";
import bgmi from "/src/assets/ai_ds/events/flagship/bgmi.png";
import cod from "/src/assets/ai_ds/events/flagship/cod.png";
import chess from "/src/assets/ai_ds/events/flagship/chess.png";
import carrom from "/src/assets/ai_ds/events/flagship/carrom.png";
...
const AIDS = () => {
    ...
    const eventCategories = {
        technical: {
            ...
            description: "Dive into the world of Artificial Intelligence, Data Science, and more with exciting challenges.",
            ...
            events: [
                { 
                    ...
                    details: "Present your ideas in AI & Data Science!", 
                    image: paperPresentation 
                },
                { 
                    name: "Ideathon", 
                    slug: "ideathon", 
                    details: "Propose unique solutions to real-world AI problems.", 
                    image: ideathon 
                },
                { 
                    name: "AI Bot Battle", 
                    slug: "ai-bot-battle", 
                    details: "Use AI tools to solve challenging problems!", 
                    image: aiBotBattle 
                }
            ],
        },
        nontechnical: {
            ...
            description: "Engage in fun and innovative challenges with AI integration and problem-solving.",
            ...
            events: [
                { 
                    name: "Treasure Hunt", 
                    slug: "treasure-hunt", 
                    details: "Solve cryptic clues to find the hidden treasure!", 
                    image: treasureHunt 
                },
                { 
                    name: "Synthicinema", 
                    slug: "synthicinema", 
                    details: "Create a short AI-generated film!", 
                    image: synthicinema 
                }
            ],
        },
        flagship: {
            ...
            events: [
                { 
                    name: "Free Fire", 
                    slug: "free-fire", 
                    details: "Battle it out in this intense survival shooter!", 
                    image: freeFire 
                },
                { 
                    name: "BGMI", 
                    slug: "bgmi", 
                    details: "Test your skills in the ultimate battlegrounds!", 
                    image: bgmi 
                },
                { 
                    name: "COD", 
                    slug: "cod", 
                    details: "Fast-paced Call of Duty action awaits!", 
                    image: cod 
                },
                { 
                    name: "Chess", 
                    slug: "chess", 
                    details: "Strategize your way to victory in this battle of minds!", 
                    image: chess 
                },
                { 
                    name: "Carrom", 
                    slug: "carrom", 
                    details: "Show off your striking skills in this classic game!", 
                    image: carrom 
                }
            ],
        }
            ...
            <div className="flex-1 text-center px-6 pt-24 relative">
                ...
                <div className="max-w-screen-lg mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-y-4 gap-x-3 justify-center">
                    {eventCategories[selectedCategory].events.map((event, index) => (
                        <div
                            key={index}
                            onClick={() => navigate(`/events/ai_ds/${selectedCategory}/${event.slug}`)}
